...
const workflows = [
  {
    href: "/medical-coding/inpatient",
    title: "Inpatient Coding",
    icon: "🛏",
    desc: "Principal diagnosis, MCC/CC capture, ICD-10 procedures and DRG severity from the admission note.",
  },
  {
    href: "/medical-coding/outpatient",
